...
import function_builder_3 as function_builder
import model_utils_3 as model_utils
import squad_utils
...
def main(_):
    ...
    # check_points = [
    #         '/home/renato/drive/xlnet/experiment/squad/model.ckpt-120000',
    #         '/home/renato/drive/xlnet/experiment/squad/model.ckpt-110000',
    #         '/home/renato/drive/xlnet/experiment/squad/model.ckpt-100000'
    # ]
    ...
    check_points = [
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-90000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-95000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-100000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-105000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-110000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-115000',
            '/home/renato/drive/xlnet/experiment_3/squad/model.ckpt-120000',
    ]

    # dir_name = '/home/renato/drive/xlnet/experiment_3/squad'
    ...
    #         s = f.split('.')
    #         file_name = s[0]+'.'+s[1]
    #         check_points.append(dir_name+'/'+file_name)
    # check_points = sorted(set(check_points), reverse=True)
    ...
    for c in check_points:
        ...
        file_name = c.split('/')[-1].split('-')[-1]
        with open('res3/{}'.format(file_name), 'w') as f:
            f.write(log_str)
        tf.logging.info("=" * 80)
